...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-ice">
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center">
            <div className="relative h-12 md:h-20 flex items-center">
              {/* Fix: changed fetchpriority to fetchPriority as suggested by compiler */}
              <img 
                src={logoUrl} 
                alt="Banzer Advocacia - Logo Oficial" 
          ...
          <div className="hidden md:block">
             <WhatsAppButton className="!py-3 !px-6 !text-[10px] !bg-transparent border border-gold/40 hover:!bg-gold/10" />
          </div>
        </div>
      </header>
      ...
      {/* 1. HERO SECTION */}
      <main>
        <section className="relative min-h-[95vh] flex flex-col justify-center bg-navy text-white overflow-hidden border-b border-gold/20 pt-28 md:pt-36">
          <div className="md:hidden w-full flex justify-center pb-4 animate-fade-in">
          ...
          <div className="container mx-auto px-6 py-8 md:py-16 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-6 animate-fade-in text-center md:text-left order-2 md:order-1">
              <div className="hidden md:inline-flex items-center space-x-2 bg-gold/20 border border-gold/30 px-4 py-2 rounded-full mb-2">
                ...
                <h2 className="text-gold font-bold text-[10px] md:text-xs tracking-widest uppercase">
                  Excelência Jurídica há 35 Anos
                </h2>
              </div>
              ...
              <p className="text-base md:text-xl text-ice/70 font-light leading-relaxed max-w-lg mx-auto md:mx-0">
                Segurança jurídica e tranquilidade absoluta para o seu patrimônio. Atendimento premium focado em agilidade e resultados concretos em São Paulo e Santa Catarina.
              </p>
            ...
            <div className="flex justify-center md:justify-end relative order-1 md:order-2 animate-fade-in" style={{animationDelay: '0.2s'}}>
              <div className="relative w-full max-w-[240px] md:max-w-[360px] aspect-[3/4] bg-navy rounded-sm overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.6)] border border-gold/20 group">
                ...
                <img 
                  src={heroPhotoUrl} 
                  alt="Dr. Hermes Banzer - Sócio Fundador da Banzer Advocacia" 
                ...
                <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6">
                  <p className="font-title text-lg md:text-xl text-gold font-bold">Dr. Hermes Banzer</p>
            ...
            <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
              ...
              <div className="bg-navy p-8 md:p-14 rounded-sm relative overflow-hidden group shadow-2xl">
                ...
                <p className="text-ice/60 leading-relaxed mb-10 text-base md:text-lg text-center md:text-left">
                  Transformamos processos complexos em soluções simples e seguras para sua família ou empresa. Atendimento especializado em regularização fundiária.
                </p>
        ...
        <section className="py-24 bg-white text-center border-t border-gray-100">
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <p className="text-gray-500 text-lg mb-10 max-w-2xl mx-auto">
              Não deixe para amanhã a segurança do que você levou uma vida para construir. Fale agora com nossa equipe de especialistas jurídicos.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-16 pb-16 border-b border-white/10">
            <div className="space-y-6">
              <img 
                src={logoUrl} 
                alt="Banzer Advocacia - Unidade Principal" 
                className="h-14 md:h-20 w-auto object-contain brightness-110 opacity-90 mb-6" 
                loading="lazy"
              />
              ...
              <div className="pt-2">
                ...
                <span className="text-ice/80 text-sm font-semibold">OAB/SP 109.692</span>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                <li className="flex items-center space-x-3 text-ice/80 text-sm hover:text-gold transition-colors">
                  ...
                  <a href="mailto:hermes@banzer.adv.br" className="font-medium">hermes@banzer.adv.br</a>
                </li>
                <li className="pt-2">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-8">
                {ADDRESSES.map((addr, idx) => (
                  <address key={idx} className="space-y-1 not-italic">
